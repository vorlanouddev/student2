					...
					<div class="row">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="height: 40px!important">
								...
								?>
								<h3 class="panel-title">ບັນທຶກໝາຍຂາດປະຈຳວັນ
							...
							<div class="panel-body">
								...
								<table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										...
										include 'mysql.php';
										$class_id=$_GET['class_id'];
										$student=mysqli_query($con,"select*from view_miss where class_id='$class_id' and date(miss_date)=date(curdate()) and m_part='$r_part'");
										$i=1;
