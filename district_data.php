                        ...
                        <div class="hpanel email-compose mailbox-view mg-b-15">
                            <div class="border-top border-left border-right bg-light">
                             ...
                             <div class="panel-heading red">
                                <h3 class="panel-title"> ຟອມບັນທຶກເມືອງ </h3>
                            </div>
                                ...
                                <div>
                                    <form action="" method="POST" role="form">                                    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dis_name" class="form-control" id="" placeholder="ກະລຸນາປ້ອນຊື່ເມືອງ" required>
                                        </div>                                    
                                            ...
                                            <?php $i=1; while($res=mysqli_fetch_array($select)){ ?>
                                                <tr  id="body">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="?del=<?php echo $res['dis_id']?>" class="btn btn-default btn-xs" onclick="return confirm('ທ່ານຕ້ອງການລຶບຂໍ້ມູນນີ້ແທ້ບໍ່ ?')"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php $i++;} ?>
...
<?php 
    ...
    $insert=mysqli_query($con,"insert into district values('','$pro_id','$dis_name')");
    if($insert){
        echo "<script>alert('ບັນທຶກສຳເລັດ');location='district_data.php';</script>";
    }else{
        echo "<script>alert('ບັນທຶກບໍ່ສຳເລັດ');location='district_data.php';</script>";
