					...
					<div class="hpanel email-compose mailbox-view mg-b-15" id="data">
						...
						<table class="table table-hover table-striped" border=1>
							<thead>
								...
								// ຈຳນວນ ເສັງຕົກ
											$sel_fail=mysqli_query($con," select count(r_id) as average from ranks where (score/'$sub' <5.0) and class_id='$cl_id' and r_month='$month1' and r_part='$r_part'");
											$count_fail=mysqli_fetch_array($sel_fail);
								// ຈຳນວນ ອານຸລົມ
											$sel_good=mysqli_query($con," select count(r_id) as average from ranks where (score/'$sub') between '5.0' and '6.9' and class_id='$cl_id' and r_month='$month1' and r_part='$r_part'");
											$count_good=mysqli_fetch_array($sel_good);
											
								// ຈຳນວນ ເສັງໄດ້ສົມບູນ
											$sel_best=mysqli_query($con," select count(r_id) as average from ranks where (score/'$sub'>7 ) and class_id='$cl_id' and r_month='$month1' and r_part='$r_part'");
