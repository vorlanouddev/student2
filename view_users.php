...
div.input-group>span.input-group-addon{height: 10px!important}
.input-group-addon {
...
<li><a href="#form-resgister"><i class="fa fa-user-plus" aria-hidden="true"></i> ສ້າງບັນຊີໃໝ່</a></li>
<li  class="active"><a href="#DATA"><i class="fa fa-users" aria-hidden="true"></i> ຂໍ້ມູນທັງໝົດ</a></li>
<li><a href="#Edit"><i class="fa fa-edit" aria-hidden="true"></i> ແກ້ໄຂຂໍ້ມູນ</a></li>
</ul>
<div id="myTabContent" class="tab-content custom-product-edit">
<div class="product-tab-list tab-pane fade " id="form-resgister">
<div class="row">
