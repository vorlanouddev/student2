					...
					<div class="row">
						<div class="panel panel-default">
							<div class="panel-heading red" style=";color:#fff">
								...
								$getcl=mysqli_query($con,"select*from class_room where class_id='$class_id1'");
							...
							<div class="panel-body">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="row red">
										...
										?>
										<h3 align='center' style="margin-top:2%;">ປະຫວັດນັກຮຽນ ລຸ້ນທີ
											<?php echo $gener?> ສົກຮຽນ
											<?php echo $part ?>
											<?php echo $cid['class_name'] ?> ທັງໝົດ
										</h3>
									</div>
								...
								<div class="dataTables_wrapper dataTables_processing">
									<table class="table table-hover" id="dataTable">
										...
										<tbody>
											...
											$part=$_POST['part'];
											$class_id1=$_POST['class_id1'];
											$student=mysqli_query($con,"select*from view_uproom1 where gener='$gener' and part='$part' and class_id='$class_id1'");
											$i=1;
